...
import { Mail, Lock, Eye, EyeOff, Chrome, Loader, AlertCircle } from 'lucide-react';
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-dark-400 mt-1">Sign in to your ValueDocs vault</p>
      </div>
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="text-xs text-dark-500 font-medium">or sign in with email</span>
        <div className="flex-1 h-px bg-dark-700" />
      </div>
